...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(895, 909)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.frame = QtWidgets.QFrame(self.centralwidget)
        self.frame.setGeometry(QtCore.QRect(0, 0, 901, 911))
        self.frame.setStyleSheet("background-color: #039874;")
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.label = QtWidgets.QLabel(self.frame)
        self.label.setGeometry(QtCore.QRect(80, -60, 741, 861))
        self.label.setText("")
        self.gif=QMovie("0b51406b38b54519b7a5b2e9107d51a4.gif")
        self.label.setMovie(self.gif)
        self.gif.start()
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(self.frame)
        self.label_2.setGeometry(QtCore.QRect(80, 830, 991, 55))
        font = QtGui.QFont()
        ...
        self.pushButton.setGeometry(QtCore.QRect(90, 630, 201, 45))
        font = QtGui.QFont()
...
"}")
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(605, 630, 201, 45))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
